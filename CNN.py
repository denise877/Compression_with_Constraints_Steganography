...
os.chdir("..")
#cwd = 'input'
cmd = '/Users/denise/Desktop/110bproject3/tiny-imagenet-200'
# Hyper Parameters
num_epochs = 100
batch_size = 2
...
MODELS_PATH = '/Users/denise/Desktop/110bproject3/models'
...
class PrepNetwork(nn.Module):
    ...
    def forward(self, p):
       # p=fftpack.dct(fftpack.dct(p.T, norm='ortho').T, norm='ortho')
        p1 = self.initialP3(p)
        p2 = self.initialP4(p)
        p3 = self.initialP5(p)
